"""Tests for the JsonLGraphDataset class."""
import os

import pytest
from dpu_utils.utils import RichPath

from tf2_gnn.data import JsonLGraphDataset, DataFold
...
def test_num_loaded_data_elements(jsonl_dataset: JsonLGraphDataset):
